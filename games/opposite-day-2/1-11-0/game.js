var game = {
    ...
    soundEffects: {
        ...
        updateMusicVolume: function (v) {
            return;
            for (var o of musicAudios) {
                audios[o].volume = v;
            }
        },
        landNumber: 0,
            ...
            for (var o of game.objects.objects) {
                ...
                if (o.red) {
                    ...
                    if (game.level.triggers.tripped("red cube ultra")) {
                        saveData.ultraRedCubesTaken[game.level.level] = true;
                    }
                } else {
                    saveData.blueCubesCollected[game.level.level] = true;
                    if (o.grey) {
                    ...
                    if (game.level.triggers.tripped("blue cube ultra")) {
                        saveData.ultraBlueCubesTaken[game.level.level] = true;
                    }
                }
                updateSaveData();
            }

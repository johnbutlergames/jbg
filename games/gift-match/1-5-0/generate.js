function bulge(t) {
    return -Math.pow(clamp(t) * 2 - 1, 2) + 1;
}

function bulgeAnimation(t) {
    return Math.sqrt(1 - Math.pow(1 - clamp(t), 2.5));
}
...
function easeIn(t) {
    return clamp(1 - Math.pow(2, -10 * t) * 1.001);
}
...
game.generate = {
    ...
    generateRandomPresent: function () {
        ...
        if (o.golden) {
            ...
            if (o.accent.type == "dots") {
                ...
                o.accent.spacing = Math.random() * 20 + o.accent.sizes[0] * 4 + o.size * 0.05;
                o.accent.offsetX = Math.random() * o.accent.spacing;
                o.accent.offsetY = Math.random() * o.accent.spacing;
    ...
    drawDotsAccent: function (ctx, o) {
        ...
        var step = o.accent.spacing;
        for (var x = -o.w / 2 + o.accent.offsetX - step, xCount = 0; x < o.w + step + o.accent.offsetX; x += step, xCount++) {
            for (var y = -o.h / 2 + o.accent.offsetY - step, yCount = 0; y < o.h + step + o.accent.offsetY; y += step, yCount++) {
